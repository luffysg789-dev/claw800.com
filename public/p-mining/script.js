(function createPMiningModule(globalScope) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      manifesto: 'P is Pay/People. 100% generated hourly by users. P is useless. Reaching 10 million people would already be a victory.',
      ...
      powerPurchaseInviteReward: '1/ Buying power rewards the inviter with 10% power.',
      powerPurchaseProjectSupport: '2/ Buying power supports project development; funds will be used to purchase servers.',
    ...
    zh: {
      ...
      manifesto: 'P is Pay/People，100% 由用户每小时产出，P无用，人数千万时就是一场胜利。',
      inviteFriends: '邀请好友',
      myInviteCode: '我的邀请码',
      copyButton: '复制',
      ...
      powerPurchaseInviteReward: '1/购买算力给邀请人奖励 10% 的算力。',
      powerPurchaseProjectSupport: '2/购买算力即是支持项目发展,资金将用于购买服务器',
  ...
  async function getNexaPublicConfig() {
    ...
    const payload = await getJson(NEXA_PUBLIC_CONFIG_ENDPOINT);
