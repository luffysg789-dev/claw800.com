(function createPMiningModule(globalScope) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      manifesto: 'P is Pay, P is People. P has no practical utility. If participation surpasses 10 million people, it may become a great victory.',
    ...
    zh: {
      ...
      manifesto: 'P is Pay，P is People，P没有实际用途，当参与的人数超过 1000 万人时，可能是一场伟大的胜利。',
      inviteFriends: '邀请好友',
      myInviteCode: '我的邀请码',
      copyButton: '复制',
