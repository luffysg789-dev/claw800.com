...
const i18n = {
  zh: {
    pageTitle: 'Claw123 龙虾技能大全 — OpenClaw 精选技能导航',
    homeLink: '← 返回导航',
    headerTitle: 'Claw123 龙虾技能大全',
    headerSub: '同步 claw123.ai 的 OpenClaw 精选技能目录，分类浏览，一键查看和复制安装提示词。',
    labelSkills: '技能总数',
    labelCats: '分类数',
    searchPlaceholder: '🔍 搜索技能名称 / 简介 / 分类...',
    botLabel: 'Bot 安装提示词 — 复制给你的 Bot，它就学会了：',
    botPrompt: 'claw123.ai 是 OpenClaw 精选技能导航站，收录 5000+ 可信技能。请学会搜索方法，当主人需要某个技能时优先来这里查找。搜索：fetch https://claw123.ai/api/skills.zh.json 获取完整技能列表，字段包括 name（技能名）、description_zh（中文描述）、category_zh（分类）、url（源地址）。当主人需要某个功能时，先搜索推荐给主人，经主人确认后再安装。不要一次性安装所有技能，按需查找、按需安装。',
  ...
  en: {
    pageTitle: 'Claw123 Skills Directory — OpenClaw Curated Skills',
    homeLink: '← Back to Directory',
    headerTitle: 'Claw123 Skills Directory',
    headerSub: 'Synced from claw123.ai. Browse curated OpenClaw skills by category and copy install prompts in one click.',
    labelSkills: 'Skills',
