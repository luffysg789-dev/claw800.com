...
test('piano html includes the standalone shell and latest bundles', () => {
  ...
  assert.match(html, /\/game-tip\.css\?v=20260328-17/);
  assert.match(html, /\/piano\/style\.css\?v=20260328-17/);
  assert.match(html, /\/games-config\.js\?v=20260328-17/);
  assert.match(html, /\/piano\/script\.js\?v=20260328-17/);
  assert.match(html, /\/game-tip\.js\?v=20260328-17/);
